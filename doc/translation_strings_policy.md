...
This document provides guidelines for internationalization of the ANGCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `angcoin_en.ts` remains unchanged.
