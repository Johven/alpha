# Bootstrappable ANGCOIN Core Builds

This directory contains the files necessary to perform bootstrappable ANGCOIN
Core builds.
...
- 24GB of free disk space on the partition that the ANGCOIN Core git repository
  resides in
...
For a ANGCOIN Core depends development environment, simply invoke
...
From the top of a clean ANGCOIN Core repository:
...
To use dongcarl's substitute server for ANGCOIN Core builds after having
