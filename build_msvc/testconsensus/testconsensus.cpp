...
// angcoin includes.
#include <..\src\script\angcoinconsensus.h>
...
int main()
{
    std::cout << "angcoinconsensus version: " << angcoinconsensus_version() << std::endl;
    ...
    auto op0Result = angcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, angcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
