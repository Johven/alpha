...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/ANGCOIN
else
  DOCKER_EXEC echo \> \$HOME/.angcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/angcoin/angcoin/pull/18288#discussion_r433189350 for
  # details.
