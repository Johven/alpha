...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ANGCOINTestFramework
    pass


class ExampleTest(ANGCOINTestFramework):
    # Each functional test is a subclass of the ANGCOINTestFramework class.
    ...
    def custom_method(self):
        ...
        ANGCOINTestFramework class so other tests can use it."""
