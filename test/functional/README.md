...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/angcoin/angcoin/pull/14884#discussion_r239585126).
...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the ANGCOINTestFramework, place overrides for the
...
- Set the `self.setup_clean_chain` variable in `set_test_params()` to control whether
  ...
  has 25 mature blocks (25x50=1250 ANG) in its wallet.
...
The [`TestShell`](test-shell.md) class exposes the ANGCOINTestFramework
...
Taken from the [python-angcoinrpc repository](https://github.com/jgarzik/python-angcoinrpc).
...
Test objects for interacting with a angcoind node over the p2p interface.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-angcoinlib)
