...
class P2PPermissionsTests(ANGCOINTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].angcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].angcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
