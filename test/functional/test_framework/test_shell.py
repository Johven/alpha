...
class TestShell:
    """Wrapper Class for ANGCOINTestFramework.

    The TestShell class extends the ANGCOINTestFramework
    ...
    class __TestShell(ANGCOINTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ANGCOINTestFramework child class.
            self.num_nodes = 1
