...
# The block reward of coinbaseoutput.nValue (50) ANG/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 ANG/block.
BLOCKS = 101
...
class TestANGCOINCli(ANGCOINTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and angcoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 ANG) to the default wallet.
            ...
            # Test angcoin-cli -generate with -rpcwallet in multiwallet mode.
