...
#ifndef ANGCOIN_INTERFACES_NODE_H
#define ANGCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a angcoin node (angcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // ANGCOIN_INTERFACES_NODE_H
