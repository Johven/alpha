    ...
    platformStyle(_platformStyle)
{
    ...
    // normal angcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying angcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ANGCOINAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
