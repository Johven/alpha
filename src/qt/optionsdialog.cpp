    ...
    mapper(nullptr)
{
    ...
    ui->angcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->angcoinAtStartup);
    ...
    ui->angcoinAtStartup->setToolTip(ui->angcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->angcoinAtStartup->setText(ui->angcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openANGCOINConfButton->setToolTip(ui->openANGCOINConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ANGCOINUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->angcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openANGCOINConfButton_clicked()
{
