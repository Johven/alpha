...
//! Entry point for ANGCOINApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ANGCOINApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ANGCOINGUI tests.
void AppTests::guiTests(ANGCOINGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ANGCOINGUI::consoleShown, this, &AppTests::consoleTests);
