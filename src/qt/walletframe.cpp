...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, ANGCOINGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &ANGCOINGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &ANGCOINGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &ANGCOINGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &ANGCOINGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &ANGCOINGUI::updateWalletStatus);
    connect(gui, &ANGCOINGUI::setPrivacy, walletView, &WalletView::setPrivacy);
