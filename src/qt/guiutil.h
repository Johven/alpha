...
#ifndef ANGCOIN_QT_GUIUTIL_H
#define ANGCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the ANGCOIN Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "angcoin:" URI into recipient object, return true on successful parsing
