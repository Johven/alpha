 ...
 */
#ifndef ANGCOIN_UTIL_SYSTEM_H
#define ANGCOIN_UTIL_SYSTEM_H
...
extern const char * const ANGCOIN_CONF_FILENAME;
extern const char * const ANGCOIN_SETTINGS_FILENAME;
