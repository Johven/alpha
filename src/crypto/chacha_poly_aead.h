...
#ifndef ANGCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define ANGCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@angcoin.
 *
 ...
 *
 * The chacha20-poly1305@angcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@angcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@angcoin are relatively fast in
...
#endif // ANGCOIN_CRYPTO_CHACHA_POLY_AEAD_H
