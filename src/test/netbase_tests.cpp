...
{
    BOOST_CHECK(TestSplitHost("www.angcoincore.org", "www.angcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.angcoincore.org]", "www.angcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.angcoincore.org:80", "www.angcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.angcoincore.org]:80", "www.angcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:50372", "127.0.0.1", 50372));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:50372", "127.0.0.1", 50372));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:50372", "::ffff:127.0.0.1", 50372));
    BOOST_CHECK(TestSplitHost("[::]:50372", "::", 50372));
    BOOST_CHECK(TestSplitHost("::50372", "::50372", -1));
    BOOST_CHECK(TestSplitHost(":50372", "", 50372));
    BOOST_CHECK(TestSplitHost("[]:50372", "", 50372));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:50372", "127.0.0.1:50372"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:50372", "[::]:50372"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
