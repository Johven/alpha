...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1ANG 10000

// amounts 50 .. 21000000
#define NUM_MULTIPLES_50ANG 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(22000000 * COIN, 0x1406f40));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1ANG; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50ANG; i++)
