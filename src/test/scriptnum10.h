...
#ifndef ANGCOIN_TEST_SCRIPTNUM10_H
#define ANGCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from ANGCOIN Core 0.10.0, for cross-comparison.
 */
public:
