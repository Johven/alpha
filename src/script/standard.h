...
#ifndef ANGCOIN_SCRIPT_STANDARD_H
#define ANGCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a angcoin address
 */
...
/**
 * Generate a ANGCOIN scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // ANGCOIN_SCRIPT_STANDARD_H
