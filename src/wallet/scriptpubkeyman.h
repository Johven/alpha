...
#ifndef ANGCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define ANGCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The ANGCOIN Core wallet was originally a collection of unrelated private
...
#endif // ANGCOIN_WALLET_SCRIPTPUBKEYMAN_H
