...
#ifndef ANGCOIN_WALLET_WALLETUTIL_H
#define ANGCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! angcoin from opening the wallet, thinking it was newly created, and
...
#endif // ANGCOIN_WALLET_WALLETUTIL_H
